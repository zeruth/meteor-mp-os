...
public class ComponentMapView {
	...
	public static ComponentMapView[] instances;
	...
	public static void unpack(@OriginalArg(3) Jagfile jag, @OriginalArg(0) Jagfile media, @OriginalArg(1) PixFontMapView[] fonts) {
		...
		instances = new ComponentMapView[count];
		...
		while (dat.pos < dat.data.length) {
			...
			@Pc(62) ComponentMapView com = instances[id] = new ComponentMapView();
			com.id = id;
			com.layer = layer;
			com.type = dat.g1();
