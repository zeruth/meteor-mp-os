...
public class PixMapMapView implements ImageProducer, ImageObserver {
	...
	public PixMapMapView(@OriginalArg(0) Component c, @OriginalArg(1) int width, @OriginalArg(3) int height) {
		this.width = width;
		this.height = height;
