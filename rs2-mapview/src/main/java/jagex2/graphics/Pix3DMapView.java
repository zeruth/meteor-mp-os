...
public class Pix3DMapView extends Pix2DMapView {
	...
	public static Pix8MapView[] textures = new Pix8MapView[50];
	...
	public static void unpackTextures(@OriginalArg(1) Jagfile jag) {
		...
		for (@Pc(9) int id = 0; id < 50; id++) {
			try {
				textures[id] = new Pix8MapView(jag, String.valueOf(id), 0);
	...
	private static int[] getTexels(@OriginalArg(0) int id) {
		...
		@Pc(79) Pix8MapView texture = textures[id];
	...
	private static void gouraudRaster(@OriginalArg(4) int x0, @OriginalArg(5) int x1, @OriginalArg(6) int color0, @OriginalArg(7) int color1, @OriginalArg(0) int[] dst, @OriginalArg(1) int offset, @OriginalArg(3) int length) {
		...
		if (jagged) {
			...
			if (trans == 0) {
				...
				int alpha = Pix3DMapView.trans;
				int invAlpha = 256 - Pix3DMapView.trans;
	...
	private static void flatRaster(@OriginalArg(4) int x0, @OriginalArg(5) int x1, @OriginalArg(0) int[] dst, @OriginalArg(1) int offset, @OriginalArg(2) int rgb) {
		...
		if (trans == 0) {
			...
			@Pc(72) int alpha = Pix3DMapView.trans;
			@Pc(76) int invAlpha = 256 - Pix3DMapView.trans;
			rgb = ((rgb & 0xFF00FF) * invAlpha >> 8 & 0xFF00FF) + ((rgb & 0xFF00) * invAlpha >> 8 & 0xFF00);
