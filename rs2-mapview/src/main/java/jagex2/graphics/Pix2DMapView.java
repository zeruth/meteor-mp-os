...
public class Pix2DMapView extends DoublyLinkable {
	...
	public static void setClipping(@OriginalArg(0) int bottom, @OriginalArg(2) int right, @OriginalArg(1) int top, @OriginalArg(4) int left) {
		...
		Pix2DMapView.boundLeft = left;
		Pix2DMapView.boundTop = top;
		Pix2DMapView.boundRight = right;
		Pix2DMapView.boundBottom = bottom;
		safeWidth = Pix2DMapView.boundRight - 1;
		centerW2D = Pix2DMapView.boundRight / 2;
		centerH2D = Pix2DMapView.boundBottom / 2;
	}
